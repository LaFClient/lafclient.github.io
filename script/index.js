(function() {
    window.onload = () => {
        ...
        .then((data) => {
            ...
            document.getElementById('releaseBadge').setAttribute('src', `https://img.shields.io/badge/${ releaseInfo.version }-Release%20Note?labelColor=000000&color=00f0ff&label=Release%20Note`);
